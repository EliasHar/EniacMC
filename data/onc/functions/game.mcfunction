...
execute as @a[nbt={ActiveEffects:[{Id:26b},{Amplifier:1b}]}] if entity @s[nbt={HurtTime:10s}] run tellraw @a [{"selector":"@s","bold":true,"color":"gold"},{"text":" Is out of this round","bold": false}] 
